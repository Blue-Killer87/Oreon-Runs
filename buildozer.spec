...
requirements = python3==3.7.6,hostpython3==3.7.6,kivy,pillow,Plyer,kivy_garden.mapview, openssl,requests,charset_normalizer,chardet,idna, urllib3,certifi, android.permissions, android
